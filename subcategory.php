<?php
	...
	$apiaccessfunction->access_url = API_URL.'categories/'.$_GET['id'].OAUTH_TOKEN_VARIABLE;
...
<!-- Header -->
	...
	<section class="events newsection">
	    <div class="container">
	        ...
	        <div class="tabs">
	            <ul class="clearfix">
	                <li><a href="#tabs-1"><?php echo $subcategories_data['subcategories'][0]['name']; ?></a></li>
	            </ul>
	            <!--  Tabs-1 -->
	            <div id="tabs-1">
	                <div class="event-container">
	                    <div class="row">
	                    	<?php 
	                    	foreach ($subcategories_data['subcategories'] as $key => $value) {
								//print_r($value) ;
	                    	?>
	                        <div class="col-md-3">
	                            <div class="event">
	                                <div class="eventsimg">
	                                   <a href="event.php?search=true&subcategory_id=<?php echo $value['id'] ?>"><img src="img/515x390.gif" alt=""></a>
	                                </div>
	                                <div class="event-content">
	                                    <h3 class="title"><?php echo $value['name'] ; ?></h3>
	                                    <a href="event.php?search=true&subcategory_id=<?php echo $value['id'] ?>" class="btn btn-pri">Go</a>
	                                </div>
	                            </div>
	                        </div>
	                        <?php
